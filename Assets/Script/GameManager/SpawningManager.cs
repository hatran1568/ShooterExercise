...
public class SpawningManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (spawningTimer.Finished)
        {
            ...
            Vector3 spawnPosition = new Vector3(Random.Range(-10, 10), 5, 1);
            switch (edge)
            {
                case 0:
                    spawnPosition = new Vector3(Random.Range(-10, 10), 5, 1);
                    break;
                case 1:
                    spawnPosition = new Vector3(Random.Range(-10, 10), -5, 1);
                    break;
                case 2:
                    spawnPosition = new Vector3(10, Random.Range(-5, 5), 1);
                    break;
                case 3:
                    spawnPosition = new Vector3(-10, Random.Range(-5, 5), 1);
                    break;
